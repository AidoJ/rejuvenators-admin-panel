...
import {
  ...
  require_is_buffer,
  require_prop_types
} from "./chunk-B6HA4APR.js";
import "./chunk-IWCMCWKT.js";
import {
  require_jsx_runtime
  ...
  "node_modules/@babel/runtime/helpers/interopRequireWildcard.js"(exports2, module2) {
    ...
    function _interopRequireWildcard(e2, t) {
      ...
      return (module2.exports = _interopRequireWildcard = function _interopRequireWildcard2(e3, t2) {
        ...
        for (var _t2 in e3)
          "default" !== _t2 && {}.hasOwnProperty.call(e3, _t2) && ((i = (o3 = Object.defineProperty) && Object.getOwnPropertyDescriptor(e3, _t2)) && (i.get || i.set) ? o3(f, _t2, i) : f[_t2] = e3[_t2]);
        return f;
...
var xe = o2(({ action: e2, resource: t, onMutationSuccess: r, onMutationError: s, autoSave: n2, submitOnEnter: i = false, warnWhenUnsavedChanges: a, redirect: p, successNotification: d, errorNotification: u, meta: y, metaData: l, queryMeta: f, mutationMeta: T, liveMode: h, liveParams: m, mutationMode: b, dataProviderName: g, onLiveEvent: F, invalidates: C, undoableTimeout: x, queryOptions: v, createMutationOptions: L, updateMutationOptions: B, id: D, overtimeOptions: S, optimisticUpdateMap: c, defaultFormValues: U, disableServerSideValidation: z2 = false } = {}) => {
  var J, me;
  let { options: w } = ge(), P = (w == null ? void 0 : w.disableServerSideValidation) || z2, W = z(), [Z] = form_default.useForm(), A = useForm({ form: Z, defaultFormValues: U }), { form: E } = A, j = RP({ onMutationSuccess: r || void 0, onMutationError: async (G, ee, le) => {
    if (P) {
      s == null || s(G, ee, le);
      return;
    }
    let ie2 = [], de = E.getFieldsValue();
    ie2 = Object.keys(Cr(de)).map((ye) => ({ name: Ts(ye), errors: void 0 })), E.setFields(ie2);
    let ce = G == null ? void 0 : G.errors;
    for (let ye in ce) {
      let ne = ce[ye], Te2 = [];
      Array.isArray(ne) && (Te2 = ne), typeof ne == "string" && (Te2 = [ne]), typeof ne == "boolean" && ne && (Te2 = ["Field is not valid."]), typeof ne == "object" && "key" in ne && (Te2 = [W(ne.key, ne.message)]), ie2.push({ name: Ts(ye), errors: Te2 });
    }
    E.setFields([...ie2]), s == null || s(G, ee, le);
  }, redirect: p, action: e2, resource: t, successNotification: d, errorNotification: u, meta: I(y, l), metaData: I(y, l), queryMeta: f, mutationMeta: T, liveMode: h, liveParams: m, mutationMode: b, dataProviderName: g, onLiveEvent: F, invalidates: C, undoableTimeout: x, queryOptions: v, createMutationOptions: L, updateMutationOptions: B, id: D, overtimeOptions: S, optimisticUpdateMap: c, autoSave: n2 }), { formLoading: k, onFinish: O, query: M, id: _, onFinishAutoSave: N } = j, { warnWhenUnsavedChanges: q2, setWarnWhen: R } = vt(), $ = a ?? q2;
  import_react76.default.useEffect(() => {
    E.resetFields();
  }, [(J = M == null ? void 0 : M.data) == null ? void 0 : J.data, _]);
  let H = o2((G) => {
    i && G.key === "Enter" && E.submit();
  }, "onKeyUp"), X = o2((G, ee) => {
    if (G && $ && R(true), n2 != null && n2.enabled) {
      R(false);
      let le = (n2 == null ? void 0 : n2.onFinish) ?? ((ie2) => ie2);
      return N(le(ee)).catch((ie2) => ie2);
    }
    return G;
  }, "onValuesChange"), re = { disabled: k, onClick: () => {
    E.submit();
  } };
  return { form: A.form, formProps: { ...A.formProps, onFinish: (G) => O(G).catch((ee) => ee), onKeyUp: H, onValuesChange: X, initialValues: (me = M == null ? void 0 : M.data) == null ? void 0 : me.data }, saveButtonProps: re, defaultFormValuesLoading: A.defaultFormValuesLoading, ...j, onFinish: async (G) => await O(G ?? A.form.getFieldsValue(true)) };
}, "useForm");
...
var ro = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoResetFormWhenClose: n2 = true, autoSave: i, invalidates: a, ...p }) => {
  var R, $;
  let [d, u] = import_react77.default.useState(false), y = ke(), { resource: l, action: f, identifier: T } = q(p.resource), h = Te(), m = Pe(), b = ht(), g = p.action ?? f ?? "", F = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), C = typeof e2 == "object" && "key" in e2 ? e2.key : l && g && e2 ? `modal-${T}-${g}` : void 0, x = xe({ meta: { ...C ? { [C]: void 0 } : {}, ...p.meta }, autoSave: i, invalidates: a, ...p }), { form: v, formProps: L, id: B, setId: D, formLoading: S, onFinish: c, autoSaveProps: U } = x, z2 = z(), { warnWhen: w, setWarnWhen: P } = vt(), { show: W, close: Z, modalProps: A } = to2({ modalProps: { open: t } }), E = A.open || false, j = { modalProps: A, form: v, formLoading: S, formProps: L, formResult: void 0, formValues: v.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: c, close: Z, open: A.open || false, show: W, visible: E };
  import_react77.default.useEffect(() => {
    var H, X, re, J;
    if (d === false && C) {
      let me = (X = (H = h == null ? void 0 : h.params) == null ? void 0 : H[C]) == null ? void 0 : X.open;
      if (typeof me == "boolean" ? me && W() : typeof me == "string" && me === "true" && W(), F) {
        let G = (J = (re = h == null ? void 0 : h.params) == null ? void 0 : re[C]) == null ? void 0 : J.id;
        G && (D == null || D(G));
      }
      u(true);
    }
  }, [C, h, F, D]), import_react77.default.useEffect(() => {
    var H;
    d === true && (E && C ? m({ query: { [C]: { ...(H = h == null ? void 0 : h.params) == null ? void 0 : H[C], open: true, ...F && B && { id: B } } }, options: { keepQuery: true }, type: "replace" }) : C && !E && m({ query: { [C]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [B, E, W, C, F]);
  let k = { disabled: S, loading: S, onClick: () => {
    v.submit();
  } }, O = (0, import_react77.useCallback)(() => {
    if (U.status === "success" && (i != null && i.invalidateOnClose) && y({ id: B, invalidates: a || ["list", "many", "detail"], dataProviderName: p.dataProviderName, resource: T }), w)
      if (window.confirm(z2("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        P(false);
      else
        return;
    D == null || D(void 0), j.close(), n2 && v.resetFields();
  }, [w, U.status]), M = (0, import_react77.useCallback)((H) => {
    typeof H < "u" && (D == null || D(H)), (!(g === "edit" || g === "clone") || (typeof H < "u" || typeof B < "u")) && j.show();
  }, [B]), { visible: _, ...N } = A, q2 = { open: _, ...N };
  return { ...x, ...j, show: M, close: O, open: E, formProps: { ...L, ...x.formProps, onValuesChange: L == null ? void 0 : L.onValuesChange, onKeyUp: L == null ? void 0 : L.onKeyUp, onFinish: async (H) => {
    await c(H), r && Z(), s && v.resetFields();
  } }, modalProps: { ...q2, width: "1000px", okButtonProps: k, title: z2(`${T}.titles.${p.action}`, `${b(`${p.action} ${((R = l == null ? void 0 : l.meta) == null ? void 0 : R.label) ?? (($ = l == null ? void 0 : l.options) == null ? void 0 : $.label) ?? (l == null ? void 0 : l.label) ?? T}`, "singular")}`), okText: z2("buttons.save", "Save"), cancelText: z2("buttons.cancel", "Cancel"), onCancel: O, forceRender: true }, formLoading: S };
}, "useModalForm");
var no2 = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  let p = ke(), [d, u] = import_react78.default.useState(false), { visible: y, show: l, close: f } = TR({ defaultVisible: t }), { resource: T, action: h, identifier: m } = q(a.resource), b = Te(), g = Pe(), F = a.action ?? h ?? "", C = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), x = typeof e2 == "object" && "key" in e2 ? e2.key : T && F && e2 ? `drawer-${(T == null ? void 0 : T.identifier) ?? (T == null ? void 0 : T.name)}-${F}` : void 0, v = xe({ meta: { ...x ? { [x]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: L, formProps: B, formLoading: D, id: S, setId: c, onFinish: U, autoSaveProps: z2 } = v;
  import_react78.default.useEffect(() => {
    var k, O, M, _;
    if (d === false && x) {
      let N = (O = (k = b == null ? void 0 : b.params) == null ? void 0 : k[x]) == null ? void 0 : O.open;
      if (typeof N == "boolean" ? N ? l() : f() : typeof N == "string" && N === "true" && l(), C) {
        let q2 = (_ = (M = b == null ? void 0 : b.params) == null ? void 0 : M[x]) == null ? void 0 : _.id;
        q2 && (c == null || c(q2));
      }
      u(true);
    }
  }, [x, b, C, c, d]), import_react78.default.useEffect(() => {
    var k;
    d === true && (y && x ? g({ query: { [x]: { ...(k = b == null ? void 0 : b.params) == null ? void 0 : k[x], open: true, ...C && S && { id: S } } }, options: { keepQuery: true }, type: "replace" }) : x && !y && g({ query: { [x]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [S, y, l, f, x, C, d]);
  let w = z(), { warnWhen: P, setWarnWhen: W } = vt(), Z = { disabled: D, onClick: () => {
    L.submit();
  }, loading: D }, A = { recordItemId: S, onSuccess: () => {
    c == null || c(void 0), f();
  } }, E = (0, import_react78.useCallback)(() => {
    if (z2.status === "success" && (n2 != null && n2.invalidateOnClose) && p({ id: S, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: m }), P)
      if (window.confirm(w("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        W(false);
      else
        return;
    f(), c == null || c(void 0);
  }, [P]), j = (0, import_react78.useCallback)((k) => {
    typeof k < "u" && (c == null || c(k)), (!(F === "edit" || F === "clone") || (typeof k < "u" || typeof S < "u")) && l();
  }, [S]);
  return { ...v, show: j, close: E, formProps: { form: L, ...v.formProps, onValuesChange: B == null ? void 0 : B.onValuesChange, onKeyUp: B == null ? void 0 : B.onKeyUp, onFinish: async (k) => {
    await U(k), r && f(), s && L.resetFields();
  } }, drawerProps: { width: "500px", onClose: E, open: y, forceRender: true }, saveButtonProps: Z, deleteButtonProps: A, formLoading: D };
}, "useDrawerForm");
var ao = o2((e2 = {}) => {
...
var ft = o2((e2, t, r) => {
  ...
  return Object.keys(e2).map((i) => {
    var d, u;
    let a = e2[i], p = ((d = t.filter((y) => y.operator !== "or").find((y) => y.field === i)) == null ? void 0 : d.operator) || ((u = n2[i]) == null ? void 0 : u.operator);
...
var gt = o2(({ onSearch: e2, initialCurrent: t, initialPageSize: r, hasPagination: s = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: d, defaultSetFilterBehavior: u, filters: y, sorters: l, syncWithLocation: f, resource: T, successNotification: h, errorNotification: m, queryOptions: b, liveMode: g, onLiveEvent: F, liveParams: C, meta: x, metaData: v, dataProviderName: L } = {}) => {
  let { tableQueryResult: B, tableQuery: D, current: S, setCurrent: c, pageSize: U, setPageSize: z2, filters: w, setFilters: P, sorters: W, setSorters: Z, sorter: A, setSorter: E, createLinkForSyncWithLocation: j, pageCount: k, overtime: O } = IC({ permanentSorter: a, permanentFilter: d, initialCurrent: t, initialPageSize: r, pagination: n2, hasPagination: s, filters: y, sorters: l, initialSorter: i, initialFilter: p, syncWithLocation: f, resource: T, defaultSetFilterBehavior: u, successNotification: h, errorNotification: m, queryOptions: b, liveMode: g, onLiveEvent: F, liveParams: C, meta: I(x, v), metaData: I(x, v), dataProviderName: L }), { syncWithLocation: M } = to(), _ = f ?? M, N = grid_default.useBreakpoint(), [q2] = form_default.useForm(), R = useForm({ form: q2 }), $ = sn(g), H = s === false ? "off" : "server", X = ((n2 == null ? void 0 : n2.mode) ?? H) !== "off", re = I(y == null ? void 0 : y.initial, p), { data: J, isFetched: me, isLoading: G } = B;
  import_react79.default.useEffect(() => {
    if (_) {
      let de = R.form.getFieldsValue(), te = Object.keys(de).reduce((ce, ye) => {
        let ne = w.find((Te2) => "field" in Te2 && Te2.field === ye);
        return ne && (ce[ye] = ne == null ? void 0 : ne.value), ce;
      }, {});
  ...
  let ee = o2((de, te, ce) => {
    ...
    X && (c == null || c(de.current || 1), z2 == null || z2(de.pageSize || 10));
  }, "onChange"), le = o2(async (de) => {
    if (e2) {
      let te = await e2(de);
      P(te), X && (c == null || c(1));
    }
  }, "onFinish"), ie2 = o2(() => X ? { itemRender: (de, te, ce) => {
    var ne;
    let ye = j({ pagination: { pageSize: U, current: de }, sorters: W, filters: w });
    if (te === "page")
      return (0, import_react79.createElement)(Fe, { to: ye, element: `${de}` });
    if (te === "next" || te === "prev")
      return (0, import_react79.createElement)(Fe, { to: ye, element: ce });
    if (te === "jump-next" || te === "jump-prev") {
      let Te2 = (ne = ce == null ? void 0 : ce.props) == null ? void 0 : ne.children;
      return (0, import_react79.createElement)(Fe, { to: ye, element: import_react79.Children.count(Te2) > 1 ? (0, import_react79.createElement)(import_react79.Fragment, {}, Te2) : Te2 });
    }
    return ce;
  }, pageSize: U, current: S, simple: !N.sm, position: N.sm ? ["bottomRight"] : ["bottomCenter"], total: J == null ? void 0 : J.total } : false, "antdPagination");
  return { searchFormProps: { ...R.formProps, onFinish: le }, tableProps: { dataSource: J == null ? void 0 : J.data, loading: $ === "auto" ? G : !me, onChange: ee, pagination: ie2(), scroll: { x: true } }, tableQueryResult: B, tableQuery: D, sorters: W, sorter: A, filters: w, setSorters: Z, setSorter: E, setFilters: P, current: S, setCurrent: c, pageSize: U, setPageSize: z2, pageCount: k, createLinkForSyncWithLocation: j, overtime: O };
}, "useTable");
var qr = o2(({ autoSubmitClose: e2 = true, ...t } = {}) => {
  let r = gt({ ...t, successNotification: void 0, errorNotification: void 0 }), s = xe({ ...t, action: "edit", redirect: false }), { id: n2, setId: i, saveButtonProps: a } = s, p = { onClick: () => {
    i(void 0);
  } }, d = o2((y) => ({ onClick: () => i(y) }), "editButtonProps"), u = o2((y) => y === n2, "isEditing");
  return { ...r, ...s, formProps: { ...s.formProps, onFinish: async (y) => {
    let l = await s.onFinish(y);
    return e2 && i(void 0), l;
  } }, saveButtonProps: a, cancelButtonProps: p, editButtonProps: d, isEditing: u };
}, "useEditableTable");
var pm = o2((e2) => {
...
var mm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: d, liveMode: u, defaultValue: y, selectedOptionsOrder: l, onLiveEvent: f, liveParams: T, meta: h, metaData: m, dataProviderName: b }) => {
  let { query: g, options: F } = PC({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: d, liveMode: u, defaultValue: y, selectedOptionsOrder: l, onLiveEvent: f, liveParams: T, meta: I(h, m), metaData: I(h, m), dataProviderName: b });
  return { checkboxGroupProps: { options: F, defaultValue: y }, query: g, queryResult: g };
}, "useCheckboxGroup");
var Tm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: d, liveMode: u, defaultValue: y, selectedOptionsOrder: l, onLiveEvent: f, liveParams: T, meta: h, metaData: m, dataProviderName: b }) => {
  let { query: g, options: F } = PC({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: p, pagination: d, liveMode: u, defaultValue: y, selectedOptionsOrder: l, onLiveEvent: f, liveParams: T, meta: I(h, m), metaData: I(h, m), dataProviderName: b });
  return { radioGroupProps: { options: F, defaultValue: y }, query: g, queryResult: g };
}, "useRadioGroup");
var Cm = o2(({ resource: e2, resourceName: t, mapData: r = o2((y) => y, "mapData"), paparseOptions: s, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: p, dataProviderName: d, onProgress: u } = {}) => {
  let y = z(), { resource: l } = q(e2 ?? t), { mutationResult: f, isLoading: T, handleChange: h } = mR({ resource: (l == null ? void 0 : l.identifier) ?? (l == null ? void 0 : l.name), mapData: r, paparseOptions: s, batchSize: n2, meta: I(a, p), metaData: I(a, p), dataProviderName: d, onFinish: i, onProgress: u ?? (({ totalAmount: m, processedAmount: b }) => {
    if (m > 0 && b > 0) {
      let g = import_react81.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react81.default.createElement(progress_default, { type: "circle", percent: Math.floor(b / m * 100), size: 50, strokeColor: "#1890ff", status: "normal" }), import_react81.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, y("notifications.importProgress", { processed: b, total: m }, `Importing: ${b}/${m}`)));
      notification_default.open({ description: g, message: null, key: `${l}-import`, duration: 0 }), b >= m, b === m && setTimeout(() => {
        notification_default.destroy(`${l}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: h, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: T }, mutationResult: f, isLoading: T };
}, "useImport");
var ns = o2(({ resource: e2, initialCurrent: t, initialPageSize: r, pagination: s, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: d, defaultSetFilterBehavior: u, filters: y, sorters: l, onSearch: f, queryOptions: T, syncWithLocation: h, successNotification: m, errorNotification: b, liveMode: g, onLiveEvent: F, liveParams: C, meta: x, metaData: v, dataProviderName: L } = {}) => {
  let { sorters: B, sorter: D, filters: S, current: c, pageSize: U, pageCount: z2, setFilters: w, setCurrent: P, setPageSize: W, setSorter: Z, setSorters: A, createLinkForSyncWithLocation: E, tableQueryResult: j, tableQuery: k, overtime: O } = IC({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: p, permanentFilter: d, filters: y, sorters: l, defaultSetFilterBehavior: u, initialCurrent: t, initialPageSize: r, queryOptions: T, successNotification: m, errorNotification: b, liveMode: g, onLiveEvent: F, liveParams: C, meta: I(x, v), metaData: I(x, v), syncWithLocation: h, dataProviderName: L, pagination: s, hasPagination: n2 }), M = n2 === false ? "off" : "server", _ = ((s == null ? void 0 : s.mode) ?? M) !== "off", N = grid_default.useBreakpoint(), q2 = sn(g), [R] = form_default.useForm(), { data: $, isFetched: H, isLoading: X } = j, re = o2((G, ee) => {
    _ && (P(G), W(ee || 10));
  }, "onChange"), J = o2(async (G) => {
    if (f) {
      let ee = await f(G);
      return _ && (P == null || P(1)), w(ee);
    }
  }, "onFinish"), me = o2(() => _ ? { itemRender: (G, ee, le) => {
    var de;
    let ie2 = E({ pagination: { pageSize: U, current: G }, sorters: B, filters: S });
    if (ee === "page")
      return (0, import_react82.createElement)(Fe, { to: ie2, element: `${G}` });
    if (ee === "next" || ee === "prev")
    ...
    return le;
  }, pageSize: U, current: c, simple: !N.sm, total: $ == null ? void 0 : $.total, onChange: re } : false, "antdPagination");
  return { searchFormProps: { form: R, onFinish: J }, listProps: { dataSource: $ == null ? void 0 : $.data, loading: q2 === "auto" ? X : !H, pagination: me() }, query: k, queryResult: j, filters: S, setFilters: w, sorter: D, setSorter: Z, sorters: B, setSorters: A, current: c, setCurrent: P, pageSize: U, setPageSize: W, pageCount: z2, createLinkForSyncWithLocation: E, overtime: O };
}, "useSimpleList");
var Um = o2(() => {
...
var ht2 = o2(({ children: e2, initialSiderCollapsed: t, onSiderCollapsed: r }) => {
...
var Ct = o2(({ Title: e2, render: t, meta: r }) => {
  let [s, n2] = (0, import_react90.useState)(false), [i, a] = (0, import_react90.useState)(false), p = yo(), d = oe(), u = yt(), { warnWhen: y, setWarnWhen: l } = vt(), { Link: f } = pe(), T = d === "legacy" ? f : u, h = Ta(), m = z(), { menuItems: b, selectedKey: g, defaultOpenKeys: F } = zu({ meta: r }), C = grid_default.useBreakpoint(), { hasDashboard: x } = ge(), v = ie(), { mutate: L } = Mr({ v3LegacyAuthProviderCompatible: !!(v != null && v.isLegacy) }), B = typeof C.lg > "u" ? false : !C.lg, D = e2 ?? h ?? Ft, S = o2((E, j) => E.map((k) => {
    let { icon: O, label: M, route: _, key: N, name: q2, children: R, parentName: $, meta: H, options: X } = k;
    if (R.length > 0)
      return import_react90.default.createElement(Sc, { key: k.key, resource: q2, action: "list", params: { resource: k } }, import_react90.default.createElement(menu_default.SubMenu, { key: k.key, icon: O ?? import_react90.default.createElement(UnorderedListOutlined_default, null), title: M }, S(R, j)));
    let re = N === j, J = !(I(H == null ? void 0 : H.parent, X == null ? void 0 : X.parent, $) !== void 0 && R.length === 0);
    return import_react90.default.createElement(Sc, { key: k.key, resource: q2, action: "list", params: { resource: k } }, import_react90.default.createElement(menu_default.Item, { key: k.key, style: { fontWeight: re ? "bold" : "normal" }, icon: O ?? (J && import_react90.default.createElement(UnorderedListOutlined_default, null)) }, import_react90.default.createElement(T, { to: _ ?? "" }, M), !s && re && import_react90.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), c = o2(() => {
    y ? window.confirm(m("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (l(false), L()) : L();
  }, "handleLogout"), U = p && import_react90.default.createElement(menu_default.Item, { key: "logout", onClick: c, icon: import_react90.default.createElement(LogoutOutlined_default, null) }, m("buttons.logout", "Logout")), z2 = x ? import_react90.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: g === "/" ? "bold" : "normal" }, icon: import_react90.default.createElement(DashboardOutlined_default, null) }, import_react90.default.createElement(T, { to: "/" }, m("dashboard.title", "Dashboard")), !s && g === "/" && import_react90.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, w = S(b, g), P = o2(() => t ? t({ dashboard: z2, items: w, logout: U, collapsed: s }) : import_react90.default.createElement(import_react90.default.Fragment, null, z2, w, U), "renderSider"), W = o2(() => import_react90.default.createElement(import_react90.default.Fragment, null, import_react90.default.createElement(menu_default, { theme: "dark", selectedKeys: g ? [g] : [], defaultOpenKeys: F, mode: "inline", onClick: () => {
    a(false), C.lg || n2(true);
  } }, P())), "renderMenu"), Z = o2(() => import_react90.default.createElement(import_react90.default.Fragment, null, import_react90.default.createElement(drawer_default, { open: i, onClose: () => a(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react90.default.createElement(layout_default, null, import_react90.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react90.default.createElement(D, { collapsed: false }), W()))), import_react90.default.createElement(button_default, { style: To, size: "large", onClick: () => a(true), icon: import_react90.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react90.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, o2(() => B ? Z() : import_react90.default.createElement(layout_default.Sider, { collapsible: true, collapsed: s, onCollapse: (E) => n2(E), collapsedWidth: 80, breakpoint: "lg" }, import_react90.default.createElement(D, { collapsed: s }), W()), "renderContent")());
}, "Sider");
var Bt = o2(() => {
...
var zs = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), p = r ?? Ct, d = t ?? Bt, u = typeof a.sm > "u" ? true : a.sm;
  return import_react89.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react89.default.createElement(p, { Title: s }), import_react89.default.createElement(layout_default, null, import_react89.default.createElement(d, null), import_react89.default.createElement(layout_default.Content, null, import_react89.default.createElement("div", { style: { minHeight: 360, padding: u ? 24 : 12 } }, e2), i && import_react89.default.createElement(i, null)), n2 && import_react89.default.createElement(n2, null)));
}, "Layout");
...
var Lt = o2(({ Title: e2, render: t, meta: r }) => {
  let { token: s } = theme_default.useToken(), [n2, i] = (0, import_react94.useState)(false), [a, p] = (0, import_react94.useState)(false), d = yo(), u = oe(), y = yt(), { warnWhen: l, setWarnWhen: f } = vt(), { Link: T } = pe(), h = u === "legacy" ? T : y, m = Ta(), b = z(), { menuItems: g, selectedKey: F, defaultOpenKeys: C } = zu({ meta: r }), x = grid_default.useBreakpoint(), { hasDashboard: v } = ge(), L = ie(), { mutate: B } = Mr({ v3LegacyAuthProviderCompatible: !!(L != null && L.isLegacy) }), D = typeof x.lg > "u" ? false : !x.lg, S = e2 ?? m ?? kt2, c = o2((E, j) => E.map((k) => {
    let { icon: O, label: M, route: _, key: N, name: q2, children: R, parentName: $, meta: H, options: X } = k;
    if (R.length > 0)
      return import_react94.default.createElement(Sc, { key: k.key, resource: q2, action: "list", params: { resource: k } }, import_react94.default.createElement(menu_default.SubMenu, { key: k.key, icon: O ?? import_react94.default.createElement(UnorderedListOutlined_default, null), title: M }, c(R, j)));
    let re = N === j, J = !(I(H == null ? void 0 : H.parent, X == null ? void 0 : X.parent, $) !== void 0 && R.length === 0);
    return import_react94.default.createElement(Sc, { key: k.key, resource: q2, action: "list", params: { resource: k } }, import_react94.default.createElement(menu_default.Item, { key: k.key, icon: O ?? (J && import_react94.default.createElement(UnorderedListOutlined_default, null)) }, import_react94.default.createElement(h, { to: _ ?? "" }, M), !n2 && re && import_react94.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), U = o2(() => {
    l ? window.confirm(b("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (f(false), B()) : B();
  }, "handleLogout"), z2 = d && import_react94.default.createElement(menu_default.Item, { key: "logout", onClick: () => U(), icon: import_react94.default.createElement(LogoutOutlined_default, null) }, b("buttons.logout", "Logout")), w = v ? import_react94.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react94.default.createElement(DashboardOutlined_default, null) }, import_react94.default.createElement(h, { to: "/" }, b("dashboard.title", "Dashboard")), !n2 && F === "/" && import_react94.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, P = c(g, F), W = o2(() => t ? t({ dashboard: w, items: P, logout: z2, collapsed: n2 }) : import_react94.default.createElement(import_react94.default.Fragment, null, w, P, z2), "renderSider"), Z = o2(() => import_react94.default.createElement(import_react94.default.Fragment, null, import_react94.default.createElement(menu_default, { selectedKeys: F ? [F] : [], defaultOpenKeys: C, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    p(false), x.lg || i(true);
  } }, W())), "renderMenu"), A = o2(() => import_react94.default.createElement(import_react94.default.Fragment, null, import_react94.default.createElement(drawer_default, { open: a, onClose: () => p(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react94.default.createElement(layout_default, null, import_react94.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` } }, import_react94.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated } }, import_react94.default.createElement(S, { collapsed: false })), Z()))), import_react94.default.createElement(button_default, { style: xo, size: "large", onClick: () => p(true), icon: import_react94.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return D ? A() : import_react94.default.createElement(layout_default.Sider, { style: { backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (E) => i(E), collapsedWidth: 80, breakpoint: "lg", trigger: import_react94.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: s.colorBgElevated } }, n2 ? import_react94.default.createElement(RightOutlined_default, { style: { color: s.colorPrimary } }) : import_react94.default.createElement(LeftOutlined_default, { style: { color: s.colorPrimary } })) }, import_react94.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated, fontSize: "14px" } }, import_react94.default.createElement(S, { collapsed: n2 })), Z());
}, "ThemedSider");
var Dt = o2(() => {
...
var xn = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), p = r ?? Lt, d = t ?? Dt, u = typeof a.sm > "u" ? true : a.sm;
  return import_react93.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react93.default.createElement(p, { Title: s }), import_react93.default.createElement(layout_default, null, import_react93.default.createElement(d, null), import_react93.default.createElement(layout_default.Content, null, import_react93.default.createElement("div", { style: { minHeight: 360, padding: u ? 24 : 12 } }, e2), i && import_react93.default.createElement(i, null)), n2 && import_react93.default.createElement(n2, null)));
}, "ThemedLayout");
...
var Rt = o2(({ Title: e2, render: t, meta: r, fixed: s, activeItemDisabled: n2 = false }) => {
  var _;
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: p, mobileSiderOpen: d, setMobileSiderOpen: u } = fo2(), y = yo(), l = (_ = (0, import_react98.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : _.direction, f = oe(), T = yt(), { warnWhen: h, setWarnWhen: m } = vt(), { Link: b } = pe(), g = f === "legacy" ? b : T, F = Ta(), C = z(), { menuItems: x, selectedKey: v, defaultOpenKeys: L } = zu({ meta: r }), B = grid_default.useBreakpoint(), { hasDashboard: D } = ge(), S = ie(), { mutate: c } = Mr({ v3LegacyAuthProviderCompatible: !!(S != null && S.isLegacy) }), U = typeof B.lg > "u" ? false : !B.lg, z2 = e2 ?? F ?? be, w = o2((N, q2) => N.map((R) => {
    let { icon: $, label: H, route: X, key: re, name: J, children: me, parentName: G, meta: ee, options: le } = R;
    if (me.length > 0)
      return import_react98.default.createElement(Sc, { key: R.key, resource: J, action: "list", params: { resource: R } }, import_react98.default.createElement(menu_default.SubMenu, { key: R.key, icon: $ ?? import_react98.default.createElement(UnorderedListOutlined_default, null), title: H }, w(me, q2)));
    let ie2 = re === q2, de = !(I(ee == null ? void 0 : ee.parent, le == null ? void 0 : le.parent, G) !== void 0 && me.length === 0), te = n2 && ie2 ? { pointerEvents: "none" } : {};
    return import_react98.default.createElement(Sc, { key: R.key, resource: J, action: "list", params: { resource: R } }, import_react98.default.createElement(menu_default.Item, { key: R.key, icon: $ ?? (de && import_react98.default.createElement(UnorderedListOutlined_default, null)), style: te }, import_react98.default.createElement(g, { to: X ?? "", style: te }, H), !a && ie2 && import_react98.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), P = o2(() => {
    h ? window.confirm(C("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (m(false), c()) : c();
  }, "handleLogout"), W = y && import_react98.default.createElement(menu_default.Item, { key: "logout", onClick: () => P(), icon: import_react98.default.createElement(LogoutOutlined_default, null) }, C("buttons.logout", "Logout")), Z = D ? import_react98.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react98.default.createElement(DashboardOutlined_default, null) }, import_react98.default.createElement(g, { to: "/" }, C("dashboard.title", "Dashboard")), !a && v === "/" && import_react98.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, A = w(x, v), E = o2(() => t ? t({ dashboard: Z, items: A, logout: W, collapsed: a }) : import_react98.default.createElement(import_react98.default.Fragment, null, Z, A, W), "renderSider"), j = o2(() => import_react98.default.createElement(menu_default, { selectedKeys: v ? [v] : [], defaultOpenKeys: L, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    u(false);
  } }, E()), "renderMenu"), k = o2(() => import_react98.default.createElement(import_react98.default.Fragment, null, import_react98.default.createElement(drawer_default, { open: d, onClose: () => u(false), placement: l === "rtl" ? "right" : "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react98.default.createElement(layout_default, null, import_react98.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react98.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react98.default.createElement(z2, { collapsed: false })), j()))), import_react98.default.createElement(button_default, { style: vo, size: "large", onClick: () => u(true), icon: import_react98.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (U)
    return k();
  ...
  let M = o2(() => {
    ...
    return import_react98.default.createElement(a ? l === "rtl" ? LeftOutlined_default : RightOutlined_default : l === "rtl" ? RightOutlined_default : LeftOutlined_default, { ...N });
  }, "renderClosingIcons");
  return import_react98.default.createElement(import_react98.default.Fragment, null, s && import_react98.default.createElement("div", { style: { width: a ? "80px" : "200px", transition: "all 0.2s" } }), import_react98.default.createElement(layout_default.Sider, { style: O, collapsible: true, collapsed: a, onCollapse: (N, q2) => {
    q2 === "clickTrigger" && p(N);
  }, collapsedWidth: 80, breakpoint: "lg", trigger: import_react98.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: i.colorBgElevated } }, M()) }, import_react98.default.createElement("div", { style: { width: a ? "80px" : "200px", padding: a ? "0" : "0 16px", display: "flex", justifyContent: a ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated, fontSize: "14px" } }, import_react98.default.createElement(z2, { collapsed: a })), j()));
}, "ThemedSiderV2");
...
var ra = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i, initialSiderCollapsed: a, onSiderCollapsed: p }) => {
  let d = grid_default.useBreakpoint(), u = r ?? Rt, y = t ?? It, l = typeof d.sm > "u" ? true : d.sm, f = !!u({ Title: s });
  return import_react97.default.createElement(ht2, { initialSiderCollapsed: a, onSiderCollapsed: p }, import_react97.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: f }, import_react97.default.createElement(u, { Title: s }), import_react97.default.createElement(layout_default, null, import_react97.default.createElement(y, null), import_react97.default.createElement(layout_default.Content, null, import_react97.default.createElement("div", { style: { minHeight: 360, padding: l ? 24 : 12 } }, e2), i && import_react97.default.createElement(i, null)), n2 && import_react97.default.createElement(n2, null))));
}, "ThemedLayoutV2");
var be = o2(({ collapsed: e2, icon: t, text: r, wrapperStyles: s }) => {
  let { title: { icon: n2, text: i } = {} } = kt(), a = typeof t > "u" ? n2 : t, p = typeof r > "u" ? i : r, { token: d } = theme_default.useToken(), u = oe(), y = yt(), { Link: l } = pe();
  return import_react100.default.createElement(u === "legacy" ? l : y, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react100.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...s } }, import_react100.default.createElement("div", { style: { height: "24px", width: "24px", color: d.colorPrimary } }, a), !e2 && import_react100.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, p)));
}, "ThemedTitleV2");
var Ht2 = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...p }) => {
  let { hidden: d, disabled: u, label: y, title: l, LinkComponent: f, to: T } = qv({ resource: e2 ?? t, meta: n2, accessControl: s }), h = u || p.disabled;
  return d || p.hidden ? null : import_react101.default.createElement(f, { to: T, replace: false, onClick: (b) => {
    if (h) {
      b.preventDefault();
      return;
    }
    a && (b.preventDefault(), a(b));
  } }, import_react101.default.createElement(button_default, { icon: import_react101.default.createElement(PlusSquareOutlined_default, null), disabled: h, title: l, className: n.CreateButton, type: "primary", ...p }, !r && (i ?? y)));
}, "CreateButton");
var Ot = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...d }) => {
  let { to: u, label: y, title: l, hidden: f, disabled: T, LinkComponent: h } = Yv({ resource: e2 ?? t, id: r, meta: i, accessControl: n2 }), m = T || d.disabled;
  return f || d.hidden ? null : import_react102.default.createElement(h, { to: u, replace: false, onClick: (g) => {
    if (m) {
      g.preventDefault();
      return;
    }
    p && (g.preventDefault(), p(g));
  } }, import_react102.default.createElement(button_default, { icon: import_react102.default.createElement(EditOutlined_default, null), disabled: m, title: l, className: n.EditButton, ...d }, !s && (a ?? y)));
}, "EditButton");
var Ye = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, onSuccess: s, mutationMode: n2, children: i, successNotification: a, errorNotification: p, hideText: d = false, accessControl: u, metaData: y, meta: l, dataProviderName: f, confirmTitle: T, confirmOkText: h, confirmCancelText: m, invalidates: b, ...g }) => {
  let { title: F, label: C, hidden: x, disabled: v, loading: L, confirmTitle: B, confirmOkLabel: D, cancelLabel: S, onConfirm: c } = qu({ resource: e2 ?? t, id: r, dataProviderName: f, invalidates: b, meta: l, onSuccess: s, mutationMode: n2, errorNotification: p, successNotification: a, accessControl: u }), U = v || g.disabled;
  return x || g.hidden ? null : import_react103.default.createElement(popconfirm_default, { key: "delete", okText: h ?? D, cancelText: m ?? S, okType: "danger", title: T ?? B, okButtonProps: { disabled: L }, onConfirm: c, disabled: U }, import_react103.default.createElement(button_default, { danger: true, loading: L, icon: import_react103.default.createElement(DeleteOutlined_default, null), title: F, disabled: U, className: n.DeleteButton, ...g }, !d && (i ?? C)));
}, "DeleteButton");
var _e2 = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, dataProviderName: n2, children: i, meta: a, metaData: p, ...d }) => {
  let { onClick: u, label: y, loading: l } = tc({ resource: e2 ?? t, id: r, dataProviderName: n2 });
  return import_react104.default.createElement(button_default, { onClick: u, icon: import_react104.default.createElement(RedoOutlined_default, { spin: l }), className: n.RefreshButton, ...d }, !s && (i ?? y));
}, "RefreshButton");
var Aa = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...d }) => {
  let { to: u, label: y, title: l, hidden: f, disabled: T, LinkComponent: h } = Zv({ resource: e2 ?? t, id: r, accessControl: n2, meta: i }), m = T || d.disabled;
  return f || d.hidden ? null : import_react105.default.createElement(h, { to: u, replace: false, onClick: (g) => {
    if (m) {
      g.preventDefault();
      return;
    }
    p && (g.preventDefault(), p(g));
  } }, import_react105.default.createElement(button_default, { disabled: m, icon: import_react105.default.createElement(EyeOutlined_default, null), title: l, className: n.ShowButton, ...d }, !s && (a ?? y)));
}, "ShowButton");
var Ze = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...p }) => {
  let { to: d, label: u, title: y, hidden: l, disabled: f, LinkComponent: T } = eD({ resource: e2 ?? t, meta: n2, accessControl: s }), h = f || p.disabled;
  return l || p.hidden ? null : import_react106.default.createElement(T, { to: d, replace: false, onClick: (b) => {
    if (h) {
      b.preventDefault();
      return;
    }
    a && (b.preventDefault(), a(b));
  } }, import_react106.default.createElement(button_default, { icon: import_react106.default.createElement(BarsOutlined_default, null), disabled: h, title: y, className: n.ListButton, ...p }, !r && (i ?? u)));
}, "ListButton");
...
var ni = o2(({ resourceNameOrRouteName: e2, resource: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: p, ...d }) => {
  let { to: u, LinkComponent: y, label: l, disabled: f, hidden: T, title: h } = Jv({ id: r, resource: t ?? e2, accessControl: n2, meta: i }), m = f || d.disabled;
  return T || d.hidden ? null : import_react109.default.createElement(y, { to: u, replace: false, onClick: (g) => {
    if (m) {
      g.preventDefault();
      return;
    }
    p && (g.preventDefault(), p(g));
  } }, import_react109.default.createElement(button_default, { icon: import_react109.default.createElement(PlusSquareOutlined_default, null), disabled: m, title: h, className: n.CloneButton, ...d }, !s && (a ?? l)));
}, "CloneButton");
...
var hi = o2(({ canCreate: e2, title: t, children: r, createButtonProps: s, resource: n2, wrapperProps: i, contentProps: a, headerProps: p, breadcrumb: d, headerButtonProps: u, headerButtons: y }) => {
  var v, L;
  let l = z(), { options: { breadcrumb: f } = {} } = ge(), T = oe(), h = ht(), { resource: m, identifier: b } = q(n2), g = e2 ?? (((m == null ? void 0 : m.canCreate) ?? !!(m != null && m.create)) || s), F = typeof d > "u" ? f : d, C = g ? { size: "middle", resource: T === "legacy" ? m == null ? void 0 : m.route : b, ...s } : void 0, x = g ? import_react111.default.createElement(Ht2, { ...C }) : null;
  return import_react111.default.createElement("div", { ...i ?? {} }, import_react111.default.createElement(ke2, { title: t ?? l(`${b}.titles.list`, h(((v = m == null ? void 0 : m.meta) == null ? void 0 : v.label) ?? ((L = m == null ? void 0 : m.options) == null ? void 0 : L.label) ?? (m == null ? void 0 : m.label) ?? b, "plural")), extra: y ? import_react111.default.createElement(space_default, { wrap: true, ...u }, typeof y == "function" ? y({ defaultButtons: x, createButtonProps: C }) : y) : x, breadcrumb: typeof F < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, F) ?? void 0 : import_react111.default.createElement(Le, null), ...p ?? {} }, import_react111.default.createElement("div", { ...a ?? {} }, r)));
}, "List");
var Di = o2(({ title: e2, saveButtonProps: t, children: r, resource: s, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: p, contentProps: d, headerButtonProps: u, headerButtons: y, footerButtonProps: l, footerButtons: f, goBack: T }) => {
  var c, U;
  let h = z(), { options: { breadcrumb: m } = {} } = ge(), b = oe(), g = Mo(), { goBack: F } = he(), C = ht(), { resource: x, action: v, identifier: L } = q(s), B = typeof i > "u" ? m : i, D = { ...n2 ? { disabled: true } : {}, ...t, htmlType: "submit" }, S = import_react112.default.createElement(import_react112.default.Fragment, null, import_react112.default.createElement(Xe, { ...D }));
  return import_react112.default.createElement("div", { ...a ?? {} }, import_react112.default.createElement(ke2, { backIcon: T, onBack: v !== "list" || typeof v < "u" ? b === "legacy" ? F : g : void 0, title: e2 ?? h(`${L}.titles.create`, `Create ${C(((c = x == null ? void 0 : x.meta) == null ? void 0 : c.label) ?? ((U = x == null ? void 0 : x.options) == null ? void 0 : U.label) ?? (x == null ? void 0 : x.label) ?? L, "singular")}`), breadcrumb: typeof B < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, B) ?? void 0 : import_react112.default.createElement(Le, null), extra: import_react112.default.createElement(space_default, { wrap: true, ...u ?? {} }, y ? typeof y == "function" ? y({ defaultButtons: null }) : y : null), ...p ?? {} }, import_react112.default.createElement(spin_default, { spinning: n2 }, import_react112.default.createElement(card_default, { bordered: false, actions: [import_react112.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...l ?? {} }, f ? typeof f == "function" ? f({ defaultButtons: S, saveButtonProps: D }) : f : S)], ...d ?? {} }, r))));
}, "Create");
var zi = o2(({ title: e2, saveButtonProps: t, mutationMode: r, recordItemId: s, children: n2, deleteButtonProps: i, canDelete: a, resource: p, isLoading: d = false, dataProviderName: u, breadcrumb: y, wrapperProps: l, headerProps: f, contentProps: T, headerButtonProps: h, headerButtons: m, footerButtonProps: b, footerButtons: g, goBack: F, autoSaveProps: C }) => {
  var X, re, J;
  let x = z(), { options: { breadcrumb: v } = {} } = ge(), { mutationMode: L } = _e(), B = r ?? L, D = oe(), S = Mo(), c = Pe(), { goBack: U, list: z2 } = he(), w = ht(), { resource: P, action: W, id: Z, identifier: A } = q(p), E = Du({ resource: P, action: "list" }), j = s ?? Z, k = typeof y > "u" ? v : y, O = (P == null ? void 0 : P.list) && !s, M = a ?? ((((X = P == null ? void 0 : P.meta) == null ? void 0 : X.canDelete) ?? (P == null ? void 0 : P.canDelete)) || i), _ = O ? { ...d ? { disabled: true } : {}, resource: D === "legacy" ? P == null ? void 0 : P.route : A } : void 0, N = { ...d ? { disabled: true } : {}, resource: D === "legacy" ? P == null ? void 0 : P.route : A, recordItemId: j, dataProviderName: u }, q2 = M ? { ...d ? { disabled: true } : {}, resource: D === "legacy" ? P == null ? void 0 : P.route : A, mutationMode: B, onSuccess: () => {
    D === "legacy" ? z2((P == null ? void 0 : P.route) ?? (P == null ? void 0 : P.name) ?? "") : c({ to: E });
  }, recordItemId: j, dataProviderName: u, ...i } : void 0, R = { ...d ? { disabled: true } : {}, ...t }, $ = import_react113.default.createElement(import_react113.default.Fragment, null, C && import_react113.default.createElement(Oo, { ...C }), O && import_react113.default.createElement(Ze, { ..._ }), import_react113.default.createElement(_e2, { ...N })), H = import_react113.default.createElement(import_react113.default.Fragment, null, M && import_react113.default.createElement(Ye, { ...q2 }), import_react113.default.createElement(Xe, { ...R }));
  return import_react113.default.createElement("div", { ...l ?? {} }, import_react113.default.createElement(ke2, { backIcon: F, onBack: W !== "list" && typeof W < "u" ? D === "legacy" ? U : S : void 0, title: e2 ?? x(`${A}.titles.edit`, `Edit ${w(((re = P == null ? void 0 : P.meta) == null ? void 0 : re.label) ?? ((J = P == null ? void 0 : P.options) == null ? void 0 : J.label) ?? (P == null ? void 0 : P.label) ?? A, "singular")}`), extra: import_react113.default.createElement(space_default, { wrap: true, ...h ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: $, listButtonProps: _, refreshButtonProps: N }) : m : $), breadcrumb: typeof k < "u" ? import_react113.default.createElement(import_react113.default.Fragment, null, k) ?? void 0 : import_react113.default.createElement(Le, null), ...f ?? {} }, import_react113.default.createElement(spin_default, { spinning: d }, import_react113.default.createElement(card_default, { bordered: false, actions: [import_react113.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...b ?? {} }, g ? typeof g == "function" ? g({ defaultButtons: H, deleteButtonProps: q2, saveButtonProps: R }) : g : H)], ...T ?? {} }, n2))));
}, "Edit");
var ep = o2(({ title: e2, canEdit: t, canDelete: r, deleteButtonProps: s, isLoading: n2 = false, children: i, resource: a, recordItemId: p, dataProviderName: d, breadcrumb: u, contentProps: y, headerProps: l, wrapperProps: f, headerButtons: T, footerButtons: h, footerButtonProps: m, headerButtonProps: b, goBack: g }) => {
  var q2, R, $;
  let F = z(), { options: { breadcrumb: C } = {} } = ge(), x = oe(), v = Mo(), L = Pe(), { goBack: B, list: D } = he(), S = ht(), { resource: c, action: U, id: z2, identifier: w } = q(a), P = Du({ resource: c, action: "list" }), W = p ?? z2, Z = typeof u > "u" ? C : u, A = (c == null ? void 0 : c.list) && !p, E = r ?? ((((q2 = c == null ? void 0 : c.meta) == null ? void 0 : q2.canDelete) ?? (c == null ? void 0 : c.canDelete)) || s), j = t ?? (c == null ? void 0 : c.canEdit) ?? !!(c != null && c.edit), k = A ? { resource: x === "legacy" ? c == null ? void 0 : c.route : w } : void 0, O = j ? { ...n2 ? { disabled: true } : {}, type: "primary", resource: x === "legacy" ? c == null ? void 0 : c.route : w, recordItemId: W } : void 0, M = E ? { ...n2 ? { disabled: true } : {}, resource: x === "legacy" ? c == null ? void 0 : c.route : w, recordItemId: W, onSuccess: () => {
    x === "legacy" ? D((c == null ? void 0 : c.route) ?? (c == null ? void 0 : c.name) ?? "") : L({ to: P });
  }, dataProviderName: d, ...s } : void 0, _ = { ...n2 ? { disabled: true } : {}, resource: x === "legacy" ? c == null ? void 0 : c.route : w, recordItemId: W, dataProviderName: d }, N = import_react114.default.createElement(import_react114.default.Fragment, null, A && import_react114.default.createElement(Ze, { ...k }), j && import_react114.default.createElement(Ot, { ...O }), E && import_react114.default.createElement(Ye, { ...M }), import_react114.default.createElement(_e2, { ..._ }));
  return import_react114.default.createElement("div", { ...f ?? {} }, import_react114.default.createElement(ke2, { backIcon: g, onBack: U !== "list" && typeof U < "u" ? x === "legacy" ? B : v : void 0, title: e2 ?? F(`${w}.titles.show`, `Show ${S(((R = c == null ? void 0 : c.meta) == null ? void 0 : R.label) ?? (($ = c == null ? void 0 : c.options) == null ? void 0 : $.label) ?? (c == null ? void 0 : c.label) ?? w, "singular")}`), extra: import_react114.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...b ?? {} }, T ? typeof T == "function" ? T({ defaultButtons: N, deleteButtonProps: M, editButtonProps: O, listButtonProps: k, refreshButtonProps: _ }) : T : N), breadcrumb: typeof Z < "u" ? import_react114.default.createElement(import_react114.default.Fragment, null, Z) ?? void 0 : import_react114.default.createElement(Le, null), ...l ?? {} }, import_react114.default.createElement(spin_default, { spinning: n2 }, import_react114.default.createElement(card_default, { bordered: false, actions: h ? [import_react114.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...m }, typeof h == "function" ? h({ defaultButtons: null }) : h)] : void 0, ...y ?? {} }, i))));
}, "Show");
...
var Hp = o2((e2) => {
  let { setSelectedKeys: t, confirm: r, clearFilters: s, mapValue: n2 = o2((f) => f, "mapValue"), selectedKeys: i, children: a } = e2, p = z(), d = o2(() => {
    s && s();
  }, "clearFilter"), u = o2(() => {
    let f;
    typeof i == "number" ? f = `${i}` : import_dayjs6.default.isDayjs(i) ? f = [i.toISOString()] : f = i, t(f), r == null || r();
  }, "onFilter"), y = o2((f) => {
    if (typeof f == "object") {
      if (Array.isArray(f)) {
        let g = n2(f, "onChange");
      ...
      let h = !f || !f.target || import_dayjs6.default.isDayjs(f) ? { target: { value: f } } : f, { target: m } = h, b = n2(m.value, "onChange");
      t(b);
      return;
    }
    let T = n2(f, "onChange");
    t(T);
  }, "onChange"), l = import_react125.default.Children.map(a, (f) => import_react125.default.isValidElement(f) ? import_react125.default.cloneElement(f, { onChange: y, value: n2(i, "value") }) : f);
  return import_react125.default.createElement("div", { style: { padding: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" } }, import_react125.default.createElement("div", { style: { marginBottom: 15 } }, l), import_react125.default.createElement(space_default, null, import_react125.default.createElement(button_default, { type: "primary", size: "small", onClick: () => u() }, import_react125.default.createElement(FilterOutlined_default, null), " ", p("buttons.filter", "Filter")), import_react125.default.createElement(button_default, { danger: true, size: "small", onClick: () => d() }, p("buttons.clear", "Clear"))));
}, "FilterDropdown");
var Yp = o2(() => {
...
var Wo = { background: "radial-gradient(50% 50% at 50% 50%, #63386A 0%, #310438 100%)", backgroundSize: "cover" };
var jo = { maxWidth: "408px", margin: "auto" };
...
var nl = o2(() => {
  ...
  return import_react127.default.createElement(layout_default, { style: Wo }, import_react127.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react127.default.createElement(col_default, { xs: 22 }, import_react127.default.createElement("div", { style: jo }, import_react127.default.createElement("div", { style: Go }, import_react127.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react127.default.createElement(card_default, { title: i, headStyle: { borderBottom: 0 } }, import_react127.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (a) => {
    s(a);
...
var cl = o2(() => se.createElement(row_default, { align: "middle", justify: "center", style: Oe.root }, se.createElement(col_default, { style: { textAlign: "center" } }, se.createElement("img", { style: { marginBottom: "48px" }, src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" }), se.createElement(typography_default.Title, { style: Oe.title }, "Welcome on board"), se.createElement("p", { style: Oe.p1 }, "Your configuration is completed."), se.createElement("p", { style: Oe.p2 }, "Now you can get started by adding your resources to the", " ", se.createElement("code", { style: Oe.code }, "resources"), " property of", " ", se.createElement("code", { style: Oe.code }, "<Refine>")), se.createElement(space_default, { size: "large", wrap: true, style: { marginTop: "70px", justifyContent: "center" } }, se.createElement("a", { href: "https://refine.dev", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(ReadOutlined_default, null) }, "Documentation")), se.createElement("a", { href: "https://refine.dev/examples", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(FolderOutlined_default, null) }, "Examples")), se.createElement("a", { href: "https://discord.gg/refine", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(TeamOutlined_default, null) }, "Community"))))), "ReadyPage");
...
var $t = o2(({ providers: e2, registerLink: t, forgotPasswordLink: r, rememberMe: s, contentProps: n2, wrapperProps: i, renderContent: a, formProps: p, title: d, hideForm: u, mutationVariables: y }) => {
  let { token: l } = theme_default.useToken(), [f] = form_default.useForm(), T = z(), h = oe(), m = yt(), { Link: b } = pe(), g = h === "legacy" ? b : m, F = ie(), { mutate: C, isLoading: x } = Ht({ v3LegacyAuthProviderCompatible: !!(F != null && F.isLegacy) }), v = d === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, d ?? import_react130.default.createElement(be, { collapsed: false })), L = import_react130.default.createElement(typography_default.Title, { level: 3, style: { color: l.colorPrimaryTextHover, ...Ie } }, T("pages.login.title", "Sign in to your account")), B = o2(() => e2 && e2.length > 0 ? import_react130.default.createElement(import_react130.default.Fragment, null, e2.map((S) => import_react130.default.createElement(button_default, { key: S.name, type: "default", block: true, icon: S.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => C({ ...y, providerName: S.name }) }, S.label)), !u && import_react130.default.createElement(divider_default, null, import_react130.default.createElement(typography_default.Text, { style: { color: l.colorTextLabel } }, T("pages.login.divider", "or")))) : null, "renderProviders"), D = import_react130.default.createElement(card_default, { title: L, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: l.colorBgElevated }, ...n2 ?? {} }, B(), !u && import_react130.default.createElement(form_default, { layout: "vertical", form: f, onFinish: (S) => C({ ...S, ...y }), requiredMark: false, initialValues: { remember: false }, ...p }, import_react130.default.createElement(form_default.Item, { name: "email", label: T("pages.login.fields.email", "Email"), rules: [{ required: true, message: T("pages.login.errors.requiredEmail", "Email is required") }, { type: "email", message: T("pages.login.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { size: "large", placeholder: T("pages.login.fields.email", "Email") })), import_react130.default.createElement(form_default.Item, { name: "password", label: T("pages.login.fields.password", "Password"), rules: [{ required: true, message: T("pages.login.errors.requiredPassword", "Password is required") }] }, import_react130.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, s ?? import_react130.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react130.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, T("pages.login.buttons.rememberMe", "Remember me"))), r ?? import_react130.default.createElement(g, { style: { color: l.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, T("pages.login.buttons.forgotPassword", "Forgot password?"))), !u && import_react130.default.createElement(form_default.Item, null, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: x, block: true }, T("pages.login.signin", "Sign in")))), t ?? import_react130.default.createElement("div", { style: { marginTop: u ? 16 : 8 } }, import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, T("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react130.default.createElement(g, { to: "/register", style: { fontWeight: "bold", color: l.colorPrimaryTextHover } }, T("pages.login.signup", "Sign up")))));
  return import_react130.default.createElement(layout_default, { style: De, ...i ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: u ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: u ? "15dvh" : "16px" } }, import_react130.default.createElement(col_default, { xs: 22 }, a ? a(D, v) : import_react130.default.createElement(import_react130.default.Fragment, null, v, D))));
}, "LoginPage");
var Yt = o2(({ providers: e2, loginLink: t, wrapperProps: r, contentProps: s, renderContent: n2, formProps: i, title: a, hideForm: p, mutationVariables: d }) => {
  let { token: u } = theme_default.useToken(), [y] = form_default.useForm(), l = z(), f = oe(), T = yt(), { Link: h } = pe(), m = f === "legacy" ? h : T, b = ie(), { mutate: g, isLoading: F } = co({ v3LegacyAuthProviderCompatible: !!(b != null && b.isLegacy) }), C = a === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, a ?? import_react131.default.createElement(be, { collapsed: false })), x = import_react131.default.createElement(typography_default.Title, { level: 3, style: { color: u.colorPrimaryTextHover, ...Ie } }, l("pages.register.title", "Sign up for your account")), v = o2(() => e2 && e2.length > 0 ? import_react131.default.createElement(import_react131.default.Fragment, null, e2.map((B) => import_react131.default.createElement(button_default, { key: B.name, type: "default", block: true, icon: B.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => g({ ...d, providerName: B.name }) }, B.label)), !p && import_react131.default.createElement(divider_default, null, import_react131.default.createElement(typography_default.Text, { style: { color: u.colorTextLabel } }, l("pages.register.divider", l("pages.login.divider", "or"))))) : null, "renderProviders"), L = import_react131.default.createElement(card_default, { title: x, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: u.colorBgElevated }, ...s ?? {} }, v(), !p && import_react131.default.createElement(form_default, { layout: "vertical", form: y, onFinish: (B) => g({ ...d, ...B }), requiredMark: false, ...i }, import_react131.default.createElement(form_default.Item, { name: "email", label: l("pages.register.email", "Email"), rules: [{ required: true, message: l("pages.register.errors.requiredEmail", "Email is required") }, { type: "email", message: l("pages.register.errors.validEmail", "Invalid email address") }] }, import_react131.default.createElement(input_default, { size: "large", placeholder: l("pages.register.fields.email", "Email") })), import_react131.default.createElement(form_default.Item, { name: "password", label: l("pages.register.fields.password", "Password"), rules: [{ required: true, message: l("pages.register.errors.requiredPassword", "Password is required") }] }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, t ?? import_react131.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, l("pages.register.buttons.haveAccount", l("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react131.default.createElement(m, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, l("pages.register.signin", l("pages.login.signin", "Sign in"))))), import_react131.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react131.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: F, block: true }, l("pages.register.buttons.submit", "Sign up")))), p && t !== false && import_react131.default.createElement("div", { style: { marginTop: p ? 16 : 8 } }, import_react131.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, l("pages.register.buttons.haveAccount", l("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react131.default.createElement(m, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, l("pages.register.signin", l("pages.login.signin", "Sign in"))))));
  return import_react131.default.createElement(layout_default, { style: De, ...r ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: p ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: p ? "15dvh" : "16px" } }, import_react131.default.createElement(col_default, { xs: 22 }, n2 ? n2(L, C) : import_react131.default.createElement(import_react131.default.Fragment, null, C, L))));
}, "RegisterPage");
var _t = o2(({ loginLink: e2, wrapperProps: t, contentProps: r, renderContent: s, formProps: n2, title: i, mutationVariables: a }) => {
  let { token: p } = theme_default.useToken(), [d] = form_default.useForm(), u = z(), y = oe(), l = yt(), { Link: f } = pe(), T = y === "legacy" ? f : l, { mutate: h, isLoading: m } = lo(), b = i === false ? null : import_react132.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react132.default.createElement(be, { collapsed: false })), g = import_react132.default.createElement(typography_default.Title, { level: 3, style: { color: p.colorPrimaryTextHover, ...Ie } }, u("pages.forgotPassword.title", "Forgot your password?")), F = import_react132.default.createElement(card_default, { title: g, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: p.colorBgElevated }, ...r ?? {} }, import_react132.default.createElement(form_default, { layout: "vertical", form: d, onFinish: (C) => h({ ...C, ...a }), requiredMark: false, ...n2 }, import_react132.default.createElement(form_default.Item, { name: "email", label: u("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true, message: u("pages.forgotPassword.errors.requiredEmail", "Email is required") }, { type: "email", message: u("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react132.default.createElement(input_default, { type: "email", size: "large", placeholder: u("pages.forgotPassword.fields.email", "Email") })), import_react132.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react132.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, u("pages.forgotPassword.buttons.haveAccount", u("pages.register.buttons.haveAccount", "Have an account? ")), " ", import_react132.default.createElement(T, { style: { fontWeight: "bold", color: p.colorPrimaryTextHover }, to: "/login" }, u("pages.forgotPassword.signin", u("pages.login.signin", "Sign in"))))), import_react132.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react132.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: m, block: true }, u("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react132.default.createElement(layout_default, { style: De, ...t ?? {} }, import_react132.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react132.default.createElement(col_default, { xs: 22 }, s ? s(F, b) : import_react132.default.createElement(import_react132.default.Fragment, null, b, F))));
}, "ForgotPasswordPage");
var Zt = o2(({ wrapperProps: e2, contentProps: t, renderContent: r, formProps: s, title: n2, mutationVariables: i }) => {
  let { token: a } = theme_default.useToken(), [p] = form_default.useForm(), d = z(), u = ie(), { mutate: y, isLoading: l } = fo({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), f = n2 === false ? null : import_react133.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, n2 ?? import_react133.default.createElement(be, { collapsed: false })), T = import_react133.default.createElement(typography_default.Title, { level: 3, style: { color: a.colorPrimaryTextHover, ...Ie } }, d("pages.updatePassword.title", "Set New Password")), h = import_react133.default.createElement(card_default, { title: T, headStyle: we, bodyStyle: Re, style: { ...Ee, backgroundColor: a.colorBgElevated }, ...t ?? {} }, import_react133.default.createElement(form_default, { layout: "vertical", form: p, onFinish: (m) => y({ ...m, ...i }), requiredMark: false, ...s }, import_react133.default.createElement(form_default.Item, { name: "password", label: d("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true, message: d("pages.updatePassword.errors.requiredPassword", "Password is required") }], style: { marginBottom: "12px" } }, import_react133.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react133.default.createElement(form_default.Item, { name: "confirmPassword", label: d("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true, message: d("pages.updatePassword.errors.requiredConfirmPassword", "Confirm password is required") }, ({ getFieldValue: m }) => ({ validator(b, g) {
    return !g || m("password") === g ? Promise.resolve() : Promise.reject(new Error(d("pages.updatePassword.errors.confirmPasswordNotMatch", "Passwords do not match")));
  ...
  return import_react133.default.createElement(layout_default, { style: De, ...e2 ?? {} }, import_react133.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react133.default.createElement(col_default, { xs: 22 }, r ? r(h, f) : import_react133.default.createElement(import_react133.default.Fragment, null, f, h))));
}, "UpdatePasswordPage");
var dd = o2((e2) => {
  let { type: t } = e2;
...
var Le = o2(({ breadcrumbProps: e2, showHome: t = true, hideIcons: r = false, meta: s, minItems: n2 = 2 }) => {
  let i = oe(), { breadcrumbs: a } = fb({ meta: s }), p = yt(), { Link: d } = pe(), { hasDashboard: u } = ge(), { resources: y } = q(), l = as("/", y), f = i === "legacy" ? d : p;
  if (a.length < n2)
    return null;
  let T = a.map(({ label: m, icon: b, href: g }) => ({ key: `breadcrumb-item-${m}`, title: import_react134.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !r && b, g ? import_react134.default.createElement(f, { to: g }, m) : import_react134.default.createElement("span", null, m)) }));
  return import_react134.default.createElement(breadcrumb_default, { items: o2(() => {
    var m, b;
    return t && (u || l.found) ? [{ key: "breadcrumb-item-home", title: import_react134.default.createElement(f, { to: "/" }, ((b = (m = l == null ? void 0 : l.resource) == null ? void 0 : m.meta) == null ? void 0 : b.icon) ?? import_react134.default.createElement(HomeOutlined_default, null)) }, ...T] : T;
...
export {
  ...
  ht2 as ThemedLayoutContextProvider,
