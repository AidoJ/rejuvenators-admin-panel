  ...
  "node_modules/stackframe/stackframe.js"(exports2, module2) {
    (function(root, factory) {
      ...
      for (var k3 = 0; k3 < stringProps.length; k3++) {
        ...
        StackFrame.prototype["set" + _capitalize(stringProps[k3])] = function(p3) {
          return function(v) {
            this[p3] = String(v);
          };
        }(stringProps[k3]);
...
var require_papaparse_min = __commonJS({
  "node_modules/papaparse/papaparse.min.js"(exports2, module2) {
    ((e, t) => {
        ...
        U(m3.step) && (t = m3.step, m3.step = function(e2) {
          ...
          var r3 = m3.quoteChar || '"', r3 = (m3.newline || (m3.newline = this.guessLineEndings(e2, r3)), a2 = false, m3.delimiter ? U(m3.delimiter) && (m3.delimiter = m3.delimiter(e2), p4.meta.delimiter = m3.delimiter) : ((r3 = ((e3, t3, i5, r4, n3) => {
            ...
            for (var u3 = 0; u3 < n3.length; u3++) {
              for (var d5, f4 = n3[u3], l4 = 0, c4 = 0, p5 = 0, g4 = (o4 = void 0, new E2({ comments: r4, delimiter: f4, newline: t3, preview: 10 }).parse(e3)), _4 = 0; _4 < g4.data.length; _4++)
      ...
      function E2(C2) {
        var S = (C2 = C2 || {}).delimiter, O = C2.newline, x = C2.comments, I3 = C2.step, A2 = C2.preview, T3 = C2.fastMode, D = null, L = false, F = null == C2.quoteChar ? '"' : C2.quoteChar, j = F;
          ...
          if (T3 || false !== T3 && -1 === i3.indexOf(F)) {
            for (var l3 = i3.split(O), c3 = 0; c3 < l3.length; c3++) {
              ...
              if (!x || d4.substring(0, a2) !== x) {
                if (o3) {
                  if (h2 = [], k3(d4.split(S)), R2(), M)
                    return w();
                } else
                  k3(d4.split(S));
                if (A2 && A2 <= c3)
                  return h2 = h2.slice(0, A2), w(true);
              }
            }
            return w();
          }
            ...
            if (i3[z2] === F)
              for (m3 = z2, z2++; ; ) {
                if (-1 === (m3 = i3.indexOf(F, m3 + 1)))
                  return r2 || u2.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: h2.length, index: z2 }), E3();
                if (m3 === n2 - 1)
                ...
                if (F === j && i3[m3 + 1] === j)
                  ...
                  if (i3.substring(m3 + 1 + y3, m3 + 1 + y3 + s2) === O) {
                    if (d4.push(i3.substring(z2, m3).replace(_3, F)), b2(m3 + 1 + y3 + s2), p4 = i3.indexOf(S, z2), m3 = i3.indexOf(F, z2), o3 && (R2(), M))
                      return w();
                    if (A2 && h2.length >= A2)
                      return w(true);
                    break;
              ...
              if (-1 === g3)
                break;
              if (d4.push(i3.substring(z2, g3)), b2(g3 + s2), o3 && (R2(), M))
                return w();
              if (A2 && h2.length >= A2)
                return w(true);
            }
      ...
      return v.parse = function(e, t) {
        ...
        if (Array.isArray(e)) {
          ...
          if ("object" == typeof e[0])
            return u2(r2 || Object.keys(e[0]), e, i3);
        } else if ("object" == typeof e)
          return "string" == typeof e.data && (e.data = JSON.parse(e.data)), Array.isArray(e.data) && (e.fields || (e.fields = e.meta && e.meta.fields || r2), e.fields || (e.fields = Array.isArray(e.data[0]) ? e.fields : "object" == typeof e.data[0] ? Object.keys(e.data[0]) : []), Array.isArray(e.data[0]) || "object" == typeof e.data[0] || (e.data = [e.data])), u2(e.fields || [], e.data || [], i3);
        throw new Error("Unable to serialize unrecognized input");
        function u2(e2, t2, i4) {
          var r3 = "", n3 = ("string" == typeof e2 && (e2 = JSON.parse(e2)), "string" == typeof t2 && (t2 = JSON.parse(t2)), Array.isArray(e2) && 0 < e2.length), s3 = !Array.isArray(t2[0]);
          if (n3 && _3) {
            for (var a3 = 0; a3 < e2.length; a3++)
              0 < a3 && (r3 += m3), r3 += k3(e2[a3], a3);
            0 < t2.length && (r3 += y3);
          }
...
var is = o((e) => {
  ...
  for (let u in r)
    Object.hasOwn(r, u) && (i2 = r[u], i2.parentName && s[i2.parentName] ? s[i2.parentName].children.push(i2) : t.push(i2));
  return t;
}, "createTreeView");
...
function lo({ v3LegacyAuthProviderCompatible: e, mutationOptions: t } = {}) {
  let r = oe(), s = Pe(), { replace: n } = he(), { forgotPassword: i2 } = xe(), { forgotPassword: a } = Ue(), { close: u, open: c2 } = He(), { keys: p3, preferLegacyKeys: l2 } = Z(), m2 = useMutation({ mutationKey: p3().auth().action("forgotPassword").get(l2), mutationFn: a, onSuccess: ({ success: d3, redirectTo: T3, error: x, successNotification: v }) => {
    d3 && (u == null || u("forgot-password-error"), v && (c2 == null || c2(ka(v)))), (x || !d3) && (c2 == null || c2(po(x))), T3 && (r === "legacy" ? n(T3) : s({ to: T3, type: "replace" }));
  }, onError: (d3) => {
    c2 == null || c2(po(d3));
...
var $t = o(({ resource: e, config: t, filters: r, hasPagination: s, pagination: n, sorters: i2, queryOptions: a, successNotification: u, errorNotification: c2, meta: p3, metaData: l2, liveMode: m2, onLiveEvent: y2, liveParams: d3, dataProviderName: T3, overtimeOptions: x } = {}) => {
  ...
  let re = useQuery({ queryKey: A2().data(L).resource(P ?? "").action("list").params({ ...U || {}, filters: w, hasPagination: V, ...V && { pagination: F }, ...i2 && { sorters: i2 }, ...(t == null ? void 0 : t.sort) && { sort: t == null ? void 0 : t.sort } }).get(E2), queryFn: (R2) => {
...
var zt = o(({ resource: e, id: t, queryOptions: r, successNotification: s, errorNotification: n, meta: i2, metaData: a, liveMode: u, onLiveEvent: c2, liveParams: p3, dataProviderName: l2, overtimeOptions: m2 }) => {
  ...
  let L = useQuery({ queryKey: g2().data(D).resource(T3 ?? "").action("one").id(t ?? "").params({ ...h || {} }).get(C2), queryFn: (w) => A2({ resource: (d3 == null ? void 0 : d3.name) ?? "", id: t, meta: { ...E2, queryContext: je(w) }, metaData: { ...E2, queryContext: je(w) } }), ...r, enabled: typeof (r == null ? void 0 : r.enabled) < "u" ? r == null ? void 0 : r.enabled : typeof t < "u", onSuccess: (w) => {
    var b;
...
var go = o(({ resource: e, ids: t, queryOptions: r, successNotification: s, errorNotification: n, meta: i2, metaData: a, liveMode: u, onLiveEvent: c2, liveParams: p3, dataProviderName: l2, overtimeOptions: m2 }) => {
  ...
  (0, import_warn_once2.default)(!w && !b, za(t, d3 == null ? void 0 : d3.name)), (0, import_warn_once2.default)(!N && !b, _a()), Pt({ resource: T3, types: ["*"], params: { ids: t ?? [], meta: U, metaData: U, subscriptionType: "useMany", ...p3 }, channel: `resources/${(d3 == null ? void 0 : d3.name) ?? ""}`, enabled: A2, liveMode: u, onLiveEvent: c2, dataProviderName: D, meta: { ...i2, dataProviderName: l2 } });
...
var To = o(({ id: e, resource: t, values: r, dataProviderName: s, successNotification: n, errorNotification: i2, meta: a, metaData: u, mutationMode: c2, undoableTimeout: p3, onCancel: l2, optimisticUpdateMap: m2, invalidates: y2, mutationOptions: d3, overtimeOptions: T3 } = {}) => {
  let { resources: x, select: v } = q(), f2 = useQueryClient(), P = le(), { mutationMode: M, undoableTimeout: Q } = _e(), g2 = z(), C2 = ie(), { mutate: h } = Re({ v3LegacyAuthProviderCompatible: !!(C2 != null && C2.isLegacy) }), D = Ye(), { log: A2 } = Je(), { notificationDispatch: E2 } = ut(), L = Ce(), U = ke(), w = ue(), { options: { textTransformers: N } } = ge(), { keys: b, preferLegacyKeys: F } = Z(), V = useMutation({ mutationFn: ({ id: R2 = e, values: S = r, resource: B = t, mutationMode: H = c2, undoableTimeout: $ = p3, onCancel: X = l2, meta: ne = a, metaData: Y = u, dataProviderName: O = s }) => {
    if (typeof R2 > "u")
      throw jt;
    if (!S)
      throw Ir;
    ...
    A2 == null || A2.mutate({ action: "update", resource: ae.name, data: Y, previousData: se, meta: { id: H, dataProviderName: ye, ...rt } }), (Ct = d3 == null ? void 0 : d3.onSuccess) == null || Ct.call(d3, R2, S, B);
  }, onError: (R2, S, B) => {
    var O;
...
var Xt = o(({ resource: e, values: t, dataProviderName: r, successNotification: s, errorNotification: n, invalidates: i2, meta: a, metaData: u, mutationOptions: c2, overtimeOptions: p3 } = {}) => {
  let l2 = ie(), { mutate: m2 } = Re({ v3LegacyAuthProviderCompatible: !!(l2 != null && l2.isLegacy) }), y2 = le(), d3 = ke(), { resources: T3, select: x } = q(), v = z(), f2 = Ye(), { log: P } = Je(), M = Ce(), Q = ue(), { options: { textTransformers: g2 } } = ge(), { keys: C2, preferLegacyKeys: h } = Z(), D = useMutation({ mutationFn: ({ resource: b = e, values: F = t, meta: V = a, metaData: G = u, dataProviderName: W = r }) => {
    if (!F)
      throw ho;
    if (!b)
      throw xo;
  ...
  }, mutationKey: C2().data().mutation("create").get(h), ...c2, meta: { ...c2 == null ? void 0 : c2.meta, ...k("useCreate", h) } }), { mutate: A2, mutateAsync: E2, ...L } = D, { elapsedTime: U } = fe({ ...p3, isLoading: L.isLoading });
  return { ...L, mutate: o((b, F) => A2(b || {}, F), "handleMutation"), mutateAsync: o((b, F) => E2(b || {}, F), "handleMutateAsync"), overtime: { elapsedTime: U } };
}, "useCreate");
...
var Po = o(({ mutationOptions: e, overtimeOptions: t } = {}) => {
  let r = ie(), { mutate: s } = Re({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), n = le(), { resources: i2, select: a } = q(), u = useQueryClient(), { mutationMode: c2, undoableTimeout: p3 } = _e(), { notificationDispatch: l2 } = ut(), m2 = z(), y2 = Ye(), { log: d3 } = Je(), T3 = Ce(), x = ke(), v = ue(), { options: { textTransformers: f2 } } = ge(), { keys: P, preferLegacyKeys: M } = Z(), Q = useMutation({ mutationFn: ({ id: C2, mutationMode: h, undoableTimeout: D, resource: A2, onCancel: E2, meta: L, metaData: U, dataProviderName: w, values: N }) => {
    let { resource: b, identifier: F } = a(A2), V = v({ resource: b, meta: I2(L, U) }), G = h ?? c2, W = D ?? p3;
  ...
  }, onMutate: async ({ id: C2, resource: h, mutationMode: D, dataProviderName: A2, meta: E2, metaData: L }) => {
    let { identifier: U } = a(h), { gqlMutation: w, gqlQuery: N, ...b } = I2(E2, L) ?? {}, F = dt(M)(U, ee(U, A2, i2), b), V = P().data(ee(U, A2, i2)).resource(U), G = D ?? c2;
  ...
  }, onSettled: (C2, h, { id: D, resource: A2, dataProviderName: E2, invalidates: L = ["list", "many"] }) => {
    let { identifier: U } = a(A2);
    x({ resource: U, dataProviderName: ee(U, E2, i2), invalidates: L }), l2({ type: "REMOVE", payload: { id: D, resource: U } });
  }, onSuccess: (C2, { id: h, resource: D, successNotification: A2, dataProviderName: E2, meta: L, metaData: U }, w) => {
    ...
    if (E2)
      for (let U of E2.previousQueries)
        u.setQueryData(U[0], U[1]);
    if (C2.message !== "mutationCancelled") {
      s(C2);
      let U = f2.singular(L), w = typeof A2 == "function" ? A2(C2, h, L) : A2;
...
var ii = o(({ ids: e, resource: t, values: r, dataProviderName: s, successNotification: n, errorNotification: i2, meta: a, metaData: u, mutationMode: c2, undoableTimeout: p3, onCancel: l2, optimisticUpdateMap: m2, invalidates: y2, mutationOptions: d3, overtimeOptions: T3 } = {}) => {
  let { resources: x, select: v } = q(), f2 = useQueryClient(), P = le(), M = z(), { mutationMode: Q, undoableTimeout: g2 } = _e(), C2 = ie(), { mutate: h } = Re({ v3LegacyAuthProviderCompatible: !!(C2 != null && C2.isLegacy) }), { notificationDispatch: D } = ut(), A2 = Ye(), E2 = Ce(), L = ke(), { log: U } = Je(), w = ue(), { options: { textTransformers: N } } = ge(), { keys: b, preferLegacyKeys: F } = Z(), V = useMutation({ mutationFn: ({ ids: R2 = e, values: S = r, resource: B = t, onCancel: H = l2, mutationMode: $ = c2, undoableTimeout: X = p3, meta: ne = a, metaData: Y = u, dataProviderName: O = s }) => {
    if (!R2)
      throw Yt;
    if (!S)
      throw Sr;
...
var di = o(({ mutationOptions: e, overtimeOptions: t } = {}) => {
  let r = ie(), { mutate: s } = Re({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), { mutationMode: n, undoableTimeout: i2 } = _e(), a = le(), { notificationDispatch: u } = ut(), c2 = z(), p3 = Ye(), l2 = Ce(), m2 = ke(), { log: y2 } = Je(), { resources: d3, select: T3 } = q(), x = useQueryClient(), v = ue(), { options: { textTransformers: f2 } } = ge(), { keys: P, preferLegacyKeys: M } = Z(), Q = useMutation({ mutationFn: ({ resource: C2, ids: h, mutationMode: D, undoableTimeout: A2, onCancel: E2, meta: L, metaData: U, dataProviderName: w, values: N }) => {
    let { resource: b, identifier: F } = T3(C2), V = v({ resource: b, meta: I2(L, U) }), G = D ?? n, W = A2 ?? i2, K = a(ee(F, w, d3)), j = o(() => K.deleteMany ? K.deleteMany({ resource: b.name, ids: h, meta: V, metaData: V, variables: N }) : lt(h.map((te) => K.deleteOne({ resource: b.name, id: te, meta: V, metaData: V, variables: N }))), "mutationFn");
  ...
  }, onMutate: async ({ ids: C2, resource: h, mutationMode: D, dataProviderName: A2, meta: E2, metaData: L }) => {
    let { identifier: U } = T3(h), { gqlMutation: w, gqlQuery: N, ...b } = I2(E2, L) ?? {}, F = dt(M)(U, ee(U, A2, d3), b), V = P().data(ee(U, A2, d3)).resource(U), G = D ?? n;
  ...
  }, onSettled: (C2, h, { resource: D, ids: A2, dataProviderName: E2, invalidates: L = ["list", "many"] }) => {
    let { identifier: U } = T3(D);
    m2({ resource: U, dataProviderName: ee(U, E2, d3), invalidates: L }), u({ type: "REMOVE", payload: { id: A2, resource: U } });
  }, onSuccess: (C2, { ids: h, resource: D, meta: A2, metaData: E2, dataProviderName: L, successNotification: U }, w) => {
    let { resource: N, identifier: b } = T3(D), F = ee(b, L, d3), V = v({ resource: N, meta: I2(A2, E2) });
...
var bi = o(({ resource: e, config: t, filters: r, hasPagination: s, pagination: n, sorters: i2, queryOptions: a, successNotification: u, errorNotification: c2, meta: p3, metaData: l2, liveMode: m2, onLiveEvent: y2, liveParams: d3, dataProviderName: T3, overtimeOptions: x }) => {
  ...
  let re = useInfiniteQuery({ queryKey: A2().data(L).resource(P).action("infinite").params({ ...U || {}, filters: w, hasPagination: V, ...V && { pagination: F }, ...i2 && { sorters: i2 }, ...(t == null ? void 0 : t.sort) && { sort: t == null ? void 0 : t.sort } }).get(E2), queryFn: (R2) => {
...
var Pt = o(({ resource: e, params: t, channel: r, types: s, enabled: n = true, liveMode: i2, onLiveEvent: a, dataProviderName: u, meta: c2 }) => {
  var f2;
  let { resource: p3, identifier: l2 } = q(e), { liveProvider: m2 } = (0, import_react18.useContext)(mt), { liveMode: y2, onLiveEvent: d3 } = (0, import_react18.useContext)(Qe), T3 = i2 ?? y2, x = ke(), v = u ?? (c2 == null ? void 0 : c2.dataProviderName) ?? ((f2 = p3 == null ? void 0 : p3.meta) == null ? void 0 : f2.dataProviderName);
...
var fP = o(({ resourceName: e, resource: t, sorter: r, sorters: s, filters: n, maxItemCount: i2, pageSize: a = 20, mapData: u = o((x) => x, "mapData"), exportOptions: c2, unparseConfig: p3, meta: l2, metaData: m2, dataProviderName: y2, onError: d3, download: T3 } = {}) => {
  let [x, v] = (0, import_react42.useState)(false), f2 = le(), P = ue(), { resource: M, resources: Q, identifier: g2 } = q(I2(t, e)), h = `${ht()(g2, "plural")}-${(/* @__PURE__ */ new Date()).toLocaleString()}`, { getList: D } = f2(ee(g2, y2, Q)), A2 = P({ resource: M, meta: I2(l2, m2) });
...
var RP = o((e = {}) => {
  var K, j, re;
  let t = ue(), r = ke(), { redirect: s } = kt(), { mutationMode: n } = _e(), { setWarnWhen: i2 } = vt(), a = fn(), u = I2(e.meta, e.metaData), c2 = e.mutationMode ?? n, { id: p3, setId: l2, resource: m2, identifier: y2, formAction: d3 } = qe({ resource: e.resource, id: e.id, action: e.action }), [T3, x] = import_react43.default.useState(false), v = d3 === "edit", f2 = d3 === "clone", P = d3 === "create", M = t({ resource: m2, meta: u }), Q = (v || f2) && !!e.resource, g2 = typeof e.id < "u", C2 = ((K = e.queryOptions) == null ? void 0 : K.enabled) === false;
...
var fn = o(() => {
  ...
  return (0, import_react44.useCallback)(({ redirect: i2, resource: a, id: u, meta: c2 = {} }) => {
    if (i2 && a)
      return a.show && i2 === "show" && u ? e(a, u, void 0, c2) : a.edit && i2 === "edit" && u ? t(a, u, void 0, c2) : a.create && i2 === "create" ? s(a, void 0, c2) : r(a, "push", c2);
  }, []);
...
var he = o(() => {
  let { resources: e } = q(), t = oe(), { useHistory: r } = pe(), s = r(), n = Te(), i2 = Pe(), a = Mo(), u = o((g2, C2 = "push") => {
    ...
    let A2 = typeof g2 == "string" ? Ee(g2, e) ?? { name: g2 } : g2, E2 = (L = Se(A2, e).find((U) => U.action === "edit")) == null ? void 0 : L.route;
    ...
    let A2 = typeof g2 == "string" ? Ee(g2, e) ?? { name: g2 } : g2, E2 = (L = Se(A2, e).find((U) => U.action === "clone")) == null ? void 0 : L.route;
    return E2 ? i2({ to: We(E2, A2 == null ? void 0 : A2.meta, n, { ...h, id: D }), type: "path", query: h.query }) : "";
    ...
    let A2 = typeof g2 == "string" ? Ee(g2, e) ?? { name: g2 } : g2, E2 = (L = Se(A2, e).find((U) => U.action === "show")) == null ? void 0 : L.route;
    return E2 ? i2({ to: We(E2, A2 == null ? void 0 : A2.meta, n, { ...h, id: D }), type: "path", query: h.query }) : "";
  }, "showUrl"), y2 = o((g2, C2 = {}) => {
    var A2;
    if (t === "legacy") {
...
var mR = o(({ resourceName: e, resource: t, mapData: r = o((l2) => l2, "mapData"), paparseOptions: s, batchSize: n = Number.MAX_SAFE_INTEGER, onFinish: i2, meta: a, metaData: u, onProgress: c2, dataProviderName: p3 } = {}) => {
  ...
  let A2 = o(({ file: E2 }) => (h(), new Promise((L) => {
...
var PC = o((e) => {
  ...
  } }, overtimeOptions: { enabled: false }, successNotification: x, errorNotification: v, meta: j, metaData: j, liveMode: C2, liveParams: L, onLiveEvent: A2, dataProviderName: N }), { elapsedTime: $ } = fe({ ...b, isLoading: H.isFetching || S.isFetching }), X = (0, import_react56.useMemo)(() => uniqBy_default(D === "in-place" ? [...s, ...i2] : [...i2, ...s], "value"), [s, i2]), ne = (0, import_react56.useRef)(E2), Y = (0, import_react56.useMemo)(() => debounce_default((O) => {
    if (ne.current) {
      r(ne.current(O));
      return;
    }
...
function IC({ initialCurrent: e, initialPageSize: t, hasPagination: r = true, pagination: s, initialSorter: n, permanentSorter: i2 = En, defaultSetFilterBehavior: a, initialFilter: u, permanentFilter: c2 = Un, filters: p3, sorters: l2, syncWithLocation: m2, resource: y2, successNotification: d3, errorNotification: T3, queryOptions: x, liveMode: v, onLiveEvent: f2, liveParams: P, meta: M, metaData: Q, dataProviderName: g2, overtimeOptions: C2 } = {}) {
  ...
  let or = $t({ resource: Ne, hasPagination: r, pagination: { current: Ke, pageSize: Ge, mode: s == null ? void 0 : s.mode }, filters: F ? St($, ve) : void 0, sorters: V ? Ur(ne, me) : void 0, queryOptions: x, overtimeOptions: C2, successNotification: d3, errorNotification: T3, meta: se, metaData: se, liveMode: A2, liveParams: P, onLiveEvent: f2, dataProviderName: g2 }), Bo = (0, import_react57.useCallback)((Ie) => {
    rt((ot) => St($, Ie, ot));
...
var zu = o(({ meta: e, hideOnMissingParameter: t = true } = { hideOnMissingParameter: true }) => {
  let r = z(), s = Ut(), n = oe(), { resource: i2, resources: a } = q(), { pathname: u } = Te(), { useLocation: c2 } = pe(), { pathname: p3 } = c2(), l2 = ht(), y2 = `/${((n === "legacy" ? An(p3) : u ? An(u) : void 0) ?? "").replace(/^\//, "")}`, d3 = i2 ? Ft(i2, a, n === "legacy") : y2 ?? "", T3 = import_react62.default.useMemo(() => {
    if (!i2)
      return [];
...
var Ao = (0, import_react63.createContext)({});
var Zu = o(({ children: e, value: t }) => {
  let r = Br(), s = (0, import_react63.useMemo)(() => ({ ...r, ...t }), [r, t]);
  return import_react63.default.createElement(Ao.Provider, { value: s }, e);
}, "MetaContextProvider");
var Br = o(() => {
  if (!(0, import_react63.useContext)(Ao))
    throw new Error("useMetaContext must be used within a MetaContextProvider");
  return (0, import_react63.useContext)(Ao);
}, "useMetaContext");
var ue = o(() => {
  let { params: e } = Te(), t = Br();
  return o(({ resource: s, meta: n } = {}) => {
    let { meta: i2 } = At(s) ?? { meta: {} }, { filters: a, sorters: u, current: c2, pageSize: p3, ...l2 } = e ?? {}, m2 = { ...i2, ...l2, ...n };
...
function tc(e) {
  let t = z(), { keys: r, preferLegacyKeys: s } = Z(), n = useQueryClient(), i2 = ke(), { identifier: a, id: u } = qe({ resource: e.resource, id: e.id }), { resources: c2 } = q(), p3 = !!n.isFetching({ queryKey: r().data(ee(a, e.dataProviderName, c2)).resource(a).action("one").get(s) }), l2 = o(() => {
...
var Kn = o(({ providers: e, registerLink: t, forgotPasswordLink: r, rememberMe: s, contentProps: n, wrapperProps: i2, renderContent: a, formProps: u, title: c2 = void 0, hideForm: p3, mutationVariables: l2 }) => {
  let m2 = oe(), y2 = yt(), { Link: d3 } = pe(), T3 = m2 === "legacy" ? d3 : y2, [x, v] = (0, import_react70.useState)(""), [f2, P] = (0, import_react70.useState)(""), [M, Q] = (0, import_react70.useState)(false), g2 = z(), C2 = ie(), { mutate: h } = Ht({ v3LegacyAuthProviderCompatible: !!(C2 != null && C2.isLegacy) }), D = o((L, U) => import_react70.default.createElement(T3, { to: L }, U), "renderLink"), A2 = o(() => e ? e.map((L) => import_react70.default.createElement("div", { key: L.name, style: { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1rem" } }, import_react70.default.createElement("button", { onClick: () => h({ ...l2, providerName: L.name }), style: { display: "flex", alignItems: "center" } }, L == null ? void 0 : L.icon, L.label ?? import_react70.default.createElement("label", null, L.label)))) : null, "renderProviders"), E2 = import_react70.default.createElement("div", { ...n }, import_react70.default.createElement("h1", { style: { textAlign: "center" } }, g2("pages.login.title", "Sign in to your account")), A2(), !p3 && import_react70.default.createElement(import_react70.default.Fragment, null, import_react70.default.createElement("hr", null), import_react70.default.createElement("form", { onSubmit: (L) => {
...
var Rc = o(({ legacyAuthProvider: e, authProvider: t, dataProvider: r, legacyRouterProvider: s, routerProvider: n, notificationProvider: i2, accessControlProvider: a, auditLogProvider: u, resources: c2, DashboardPage: p3, ReadyPage: l2, LoginPage: m2, catchAll: y2, children: d3, liveProvider: T3, i18nProvider: x, Title: v, Layout: f2, Sider: P, Header: M, Footer: Q, OffLayoutArea: g2, onLiveEvent: C2, options: h }) => {
  let { optionsWithDefaults: D, disableTelemetryWithDefault: A2, reactQueryWithDefaults: E2 } = Jr({ options: h }), L = kr(() => {
    var b;
...
function Ec({ redirectOnFail: e = true, appendCurrentPathToQuery: t = true, children: r, fallback: s, loading: n, params: i2 }) {
  ...
  if (!c2)
    return import_react84.default.createElement(import_react84.default.Fragment, null, r ?? null);
  if (x)
    return import_react84.default.createElement(import_react84.default.Fragment, null, n ?? null);
  if (M)
    return import_react84.default.createElement(import_react84.default.Fragment, null, r ?? null);
  if (typeof s < "u")
    return import_react84.default.createElement(import_react84.default.Fragment, null, s ?? null);
...
papaparse/papaparse.min.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-4DXCTGIS.js.map
